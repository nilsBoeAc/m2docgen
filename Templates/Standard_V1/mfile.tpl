...
<h2><a name="_in"></a>Input <a href="#_top"></a></h2><hr class="btw">
<div class="fragment"><pre class="io">{INPUT}</pre></div>
<!-- END INPUT / important comment -->

<!-- START OUTPUT / important comment -->
<h2><a name="_in"></a>Output <a href="#_top"></a></h2><hr class="btw">
...
{TOTAL_CALL}
<!-- START NAME_CALL -->
<pre class = "text">{NAME_CALL}This function calls:</pre><ul>
<!-- functRef above / important comment -->
</ul>
<!-- END NAME_CALL -->
<!-- START NAME_CALLED -->
<pre class = "text">{NAME_CALLED}This function called by:</pre><ul>
<!-- functReRef above / important comment -->
</ul>
<!-- END NAME_CALLED -->
...
<!-- START SUBFUNCTIONS -->
<h2><a name="_subfunctions"></a>SUBFUNCTIONS <a href="#_top"></a></h2><hr  class="btw">
<ul> 
{SUBFUNCTIONS}
<!-- subFunct above / important comment -->
</ul>
<!-- END SUBFUNCTIONS -->
